...
class TempoDropdown extends StatelessWidget {
  final Tempo? valorSelecionado;
  final bool obrigatorio;
  final ValueChanged<Tempo?> onValueChanged;
  final String? label;
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonFormField2<Tempo>(
      isExpanded: true,
      value: valorSelecionado ?? Tempo.semana, //Default
      ...
      items: Tempo.values.map((filtro) {
        return DropdownMenuItem<Tempo>(
          value: filtro,
          child: Text(
            filtro.nomeTempo,
            style: TextStyle(
