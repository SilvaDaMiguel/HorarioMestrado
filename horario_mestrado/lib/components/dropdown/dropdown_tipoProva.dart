...
class TipoProvaDropdown extends StatelessWidget {
  final TipoProva? valorSelecionado;
  final bool obrigatorio;
  final ValueChanged<TipoProva?> onValueChanged;
  final String? label;

  const TipoProvaDropdown({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonFormField2<TipoProva>(
      isExpanded: true,
      ...
      items: TipoProva.values.map((tipoProva) {
        return DropdownMenuItem<TipoProva>(
          value: tipoProva,
          child: Text(
            tipoProva.nomeTipoProva,
            style: TextStyle(
